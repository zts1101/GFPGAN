...
2. 在线演示: [Huggingface](https://huggingface.co/spaces/akhaliq/GFPGAN) (仅返回裁剪的脸)
3. 在线演示: [Replicate.ai](https://replicate.com/xinntao/gfpgan) (可能需要登录，返回整个图像)
4. 我们提供一个 *干净* 的版本, 可以在没有CUDA扩展的情况下运行。因此它可以在**Windows** 或 **CPU mode**运行.
